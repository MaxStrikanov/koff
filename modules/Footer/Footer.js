  ...
  getHTML() {
    return `
      <div class="footer__contacts contacts">
        ...
        <ul class="footer__developer_items">
          <li class="footer__developer_item">
            Designer: 
            <a href="#" class="footer__developer_link">Elena Masova</a>
          </li>
          <li class="footer__developer_item">
            Developer:
            <a href="#" class="footer__developer_link">Max Strikanov</a>
          </li>
        </ul>
